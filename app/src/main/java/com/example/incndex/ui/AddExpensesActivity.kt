...
class AddExpensesActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.tvTitleIncome.setText("Add Expenses")
        ...
        binding.tvCategory.addTextChangedListener(object : TextWatcher {
            ...
            override fun afterTextChanged(s: Editable?) {
                ...
                if (filteredItems.size == 0) binding.tvAddCategory.visibility =
                    View.VISIBLE else binding.tvAddCategory.visibility = View.GONE
        ...
        binding.tvSubmit.setOnClickListener {
            if(validation()) {
                CoroutineScope(Dispatchers.IO).launch {
                    ...
                    totalIncome -= binding.etAmount.text.toString().toDouble()
        ...
        public fun validation() : Boolean{
            if(binding.tvCategory.text.trim().isEmpty()){
                ...
                return false
            }else if(binding.tvSelectDate.text.toString().isEmpty()){
